...
export type CustomerSummaryQueryVariables = CustomerAccountAPI.Exact<{
  language?: CustomerAccountAPI.InputMaybe<CustomerAccountAPI.LanguageCode>;
}>;
...
export type WishlistCustomerOwnerQueryVariables = CustomerAccountAPI.Exact<{
  language?: CustomerAccountAPI.InputMaybe<CustomerAccountAPI.LanguageCode>;
}>;

export type WishlistCustomerOwnerQuery = {
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query CustomerSummary($language: LanguageCode) @inContext(language: $language) {\n    customer {\n      id\n      firstName\n      lastName\n    }\n  }\n': {
    return: CustomerSummaryQuery;
    variables: CustomerSummaryQueryVariables;
  };
  ...
  '#graphql\n  query WishlistCustomerOwner($language: LanguageCode)\n  @inContext(language: $language) {\n    customer {\n      id\n    }\n  }\n': {
    return: WishlistCustomerOwnerQuery;
    variables: WishlistCustomerOwnerQueryVariables;
  };
}
