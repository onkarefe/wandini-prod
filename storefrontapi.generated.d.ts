...
export type GetAllProductsMetaobjectQueryVariables = StorefrontAPI.Exact<{
  [key: string]: never;
}>;

export type GetAllProductsMetaobjectQuery = {
  metaobjects: {
    edges: Array<{
      node: Pick<StorefrontAPI.Metaobject, 'id' | 'handle' | 'type'> & {
        fields: Array<
    ...
    nodes: Array<
      Pick<StorefrontAPI.Blog, 'title' | 'handle'> & {
        seo?: StorefrontAPI.Maybe<
          Pick<StorefrontAPI.Seo, 'title' | 'description'>
        >;
        articles: {nodes: Array<Pick<StorefrontAPI.Article, 'excerpt'>>};
...
> & {
  ...
  deliveryAndShipping?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Metafield, 'value' | 'type'>
  >;
  installationVideo?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Metafield, 'value' | 'type'>
  >;
