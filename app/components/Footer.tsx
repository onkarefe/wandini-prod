        ...
        {(footer) => (
          <footer className="custom-footer">
                    ...
                    <div className="footer-section">
                      ...
                      <ul className="footer-links">
                        <li>
                          <button
                            type="button"
                            className="socialLinks socialLinksButton facebook"
                        ...
                        <li>
                          <button
                            type="button"
                            className="socialLinks socialLinksButton instagram"
                        ...
                        <li>
                          <button
                            type="button"
                            className="socialLinks socialLinksButton linkedin"
            ...
            <div className="footerSubBanner">
              <div className="container mx-auto">
                <span>Copyright © 2025 - Wandini. All Rights Reserved</span>
              </div>
            </div>
          </footer>
        )}
